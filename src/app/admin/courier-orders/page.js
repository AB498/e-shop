        ...
        <div className="flex flex-wrap gap-3 w-full sm:w-auto">
          <div className="flex rounded-md shadow-sm">
            <button
              ...
              className={`px-3 py-2 text-sm font-medium rounded-l-md ${filterType === 'all'
                  ? 'bg-emerald-600 text-white'
                  : 'bg-white text-gray-700 hover:bg-gray-50'
                } border border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500`}
            >
              All
            </button>
            <button
              onClick={() => internalCourierEnabled && setFilterType('internal')}
              className={`px-3 py-2 text-sm font-medium ${filterType === 'internal'
                  ? 'bg-emerald-600 text-white'
                  : 'bg-white text-gray-700 hover:bg-gray-50'
                } border-t border-b border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 ${!internalCourierEnabled ? 'opacity-50 cursor-not-allowed' : ''}`}
            ...
            <button
              ...
              className={`px-3 py-2 text-sm font-medium rounded-r-md ${filterType === 'external'
                  ? 'bg-emerald-600 text-white'
                  : 'bg-white text-gray-700 hover:bg-gray-50'
                } border border-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500`}
            >
