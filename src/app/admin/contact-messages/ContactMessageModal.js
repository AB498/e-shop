          ...
          <div className="px-6 py-4">
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                rows={4}
                className="w-full rounded-md border border-gray-300 bg-gray-50 shadow-sm focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:bg-white sm:text-sm px-3 py-2 transition-colors"
