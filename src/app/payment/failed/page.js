...
function FailedContent() {
  ...
  // Function to restore cart items from the failed order
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto px-4 py-16 flex-grow">
        <div className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <h1 className="text-3xl font-bold text-[#253D4E] mb-4">Payment Failed</h1>

          <p className="text-[#7E7E7E] mb-6">
            We're sorry, but your payment could not be processed. Your order has not been placed.
          </p>
...
export default function PaymentFailedPage() {
  return (
    <Suspense fallback={<FailedPageSkeleton />}>
      <FailedContent />
    </Suspense>
  );
}
