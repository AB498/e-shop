...
const ContactHeader = () => {
  return (
    <div className="px-4 sm:px-8 md:px-10 lg:px-12 w-full bg-[url('/images/breadcrumb/breadcrumb-bg.png')] bg-cover bg-center py-8 md:py-10 lg:py-12 rounded-[20px]">
      <ResponsiveContainer>
        <h1 className="text-3xl md:text-4xl lg:text-[42px] font-bold text-[#253D4E] mb-4">Contact</h1>
        <div className="flex items-center">
          ...
          <span className="text-[#7E7E7E] font-semibold text-xs sm:text-sm md:text-[14px] uppercase">Contact</span>
        </div>
      </ResponsiveContainer>
    </div>
  );
