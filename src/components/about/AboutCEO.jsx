...
const AboutCEO = () => {
  return (
    <section className="py-8 md:py-12 lg:py-16">
      <ResponsiveContainer>
        <div className="flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-12 items-start max-w-[1185px] mx-auto">
          ...
          <div className="w-full md:w-1/2 md:pl-4 flex flex-col">
            <div className="overflow-auto">
              <ResponsiveText
                as="p"
                className="text-sm md:text-base lg:text-[16px] text-[#202435] mb-2 md:mb-3 lg:mb-4 font-normal"
              >
              ...
              <ResponsiveText
                as="h3"
                className="text-xl md:text-2xl lg:text-[28px] font-semibold text-[#202435] mb-3 md:mb-4 lg:mb-6 leading-[1.2]"
              >
