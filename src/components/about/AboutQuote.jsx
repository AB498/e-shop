...
const AboutQuote = () => {
  return (
    <section className="mt-0 md:-mt-8 lg:-mt-16 relative z-10 px-4 md:px-6">
      <div className="mx-auto max-w-4xl">
        <div className="max-w-[1055px] mx-auto bg-white rounded-[7px] py-6 sm:py-8 md:py-10 lg:py-[60px] px-6 sm:px-8 md:px-10 lg:pl-[100px] lg:pr-[60px] shadow-sm">
